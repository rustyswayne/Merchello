namespace Merchello.Tests.Unit.Persistence.Mappers
{
    ...
    [TestFixture]
    public class ItemCacheLineItemMapperTests : EntityKeyMapperTestBase
    {
        protected override string TableName
        {
            get
            {
                return "merchItemCacheItem";
            }
        }

        protected override BaseMapper GetMapper()
        {
            return new ItemCacheLineItemMapper();
        }
        ...
        public void Can_Map_ContainerKey_Property()
        {
            ...
            //// Assert
            Assert.That(column, Is.EqualTo($"[{TableName}].[itemCacheKey]"));
        }
