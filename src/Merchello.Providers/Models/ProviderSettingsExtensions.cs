namespace Merchello.Providers.Models
{
    ...
    public static class ProviderSettingsExtensions
    {
        ...
        public static BraintreeProviderSettings GetBrainTreeProviderSettings(this ExtendedDataCollection extendedData)
        {
            ...
            if (extendedData.ContainsKey(Providers.Constants.Braintree.ExtendedDataKeys.ProviderSettings))
            {
                var json = extendedData.GetValue(Providers.Constants.Braintree.ExtendedDataKeys.ProviderSettings);
        ...
        public static PayPalProviderSettings GetPayPalProviderSettings(this ExtendedDataCollection extendedData)
        {
            ...
            if (extendedData.ContainsKey(Providers.Constants.PayPal.ExtendedDataKeys.ProviderSettings))
            {
                var json = extendedData.GetValue(Providers.Constants.PayPal.ExtendedDataKeys.ProviderSettings);
        ...
        private static IPaymentProviderSettings GetProviderSettings(this PaymentGatewayProviderBase provider)
        {
            ...
            if (provider.ExtendedData.ContainsKey(att.Key))
            {
                ...
                {
                    MultiLogHelper.Error(typeof(ProviderSettingsExtensions), "Failed to deserialize provider settings attempting to return default settings.", ex);
                }
            }
