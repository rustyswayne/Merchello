namespace Merchello.Providers.Notification.Smtp
{
    ...
    public class SmtpNotificationGatewayProviderSettings
    {
        ...
        /// </summary>
        public virtual bool HasCredentials => !string.IsNullOrEmpty(this.UserName) && !string.IsNullOrEmpty(this.Password);
        ...
        public virtual NetworkCredential Credentials
        {
            get
            {
                ...
                return this._credentials ?? (this._credentials = new NetworkCredential(this.UserName, this.Password));
            }
        }
    }
}