namespace Merchello.Providers
{
    ...
    public static partial class Constants
    {
        ...
        public static class Braintree
        {
            ...
            /// </summary>
            public static Guid GatewayProviderSettingsKey => new Guid(GatewayProviderKey);

            /// <summary>
            /// Gets the transaction channel.
            /// </summary>
            public static string TransactionChannel => "MerchelloBraintreePaymentProvider";
            ...
            public static class ExtendedDataKeys
            {
                ...
                /// </summary>
                public static string BraintreeTransaction => "braintreeTransaction";
            }
            ...
            public static class ProcessorArguments
            {
                ...
                /// </summary>
                public static string PaymentMethodNonce => "nonce-from-the-client";

                /// <summary>
                /// Gets the key for the payment method token.
                /// </summary>
                public static string PaymentMethodToken => "the_token";
