namespace Merchello.Core.Gateways.Shipping
{
    ...
    public abstract class ShippingGatewayProviderBase : GatewayProviderBase, IShippingGatewayProvider        
    {
        ...
        /// <summary>
        /// Gets or sets the collection of all <see cref="IShipMethod"/> associated with this provider
        /// </summary>
        ...
        /// <summary>
        /// Saves a <see cref="IShippingGatewayMethod"/>
        /// </summary>
        ...
        /// <param name="shipCountrKey">The <see cref="IShipCountry"/> key</param>
        ...
        public virtual IEnumerable<IShipmentRateQuote> QuoteShippingGatewayMethodsForShipment(IShipment shipment, bool tryGetCached = true)
        {
            ...
            var strategy = GetRateQuoteStrategy(shipment, gatewayShipMethods.ToArray());
            
            return QuoteShippingGatewayMethodsForShipment(strategy, tryGetCached);
        }
        ...
        {
            var strategy = GetRateQuoteStrategy(shipment, new[] { shippingGatewayMethod });
            
            return QuoteShippingGatewayMethodsForShipment(strategy, tryGetCached).FirstOrDefault();
        }
        ...
        /// </returns>
        public IEnumerable<IShipmentRateQuote> QuoteShippingGatewayMethodsForShipment(IShipmentRateQuoteStrategy strategy, bool tryGetCached = true)
        {
