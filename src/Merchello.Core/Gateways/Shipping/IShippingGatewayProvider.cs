...
namespace Merchello.Core.Gateways.Shipping
{
    ...
    /// </summary>
    public interface IShippingGatewayProvider : IGatewayProvider
    {
        /// <summary>
        ...
        IEnumerable<IShipmentRateQuote> QuoteShippingGatewayMethodsForShipment(IShipment shipment, bool tryGetCached = true);
        ...
        /// </returns>
        IEnumerable<IShipmentRateQuote> QuoteShippingGatewayMethodsForShipment(IShipmentRateQuoteStrategy strategy, bool tryGetCached = true);
    }
}