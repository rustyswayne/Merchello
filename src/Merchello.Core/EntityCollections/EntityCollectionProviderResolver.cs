namespace Merchello.Core.EntityCollections
{
    ...
    internal class EntityCollectionProviderResolver : ContainerLazyManyObjectsResolver<EntityCollectionProviderResolver, IEntityCollectionProvider>, IEntityCollectionProviderResolver
    {
        ...
        /// The logger.
        /// </param>
        /// <param name="typeListProducerList">
        /// The type list producer list.
        /// </param>
        ...
        {
            var foundTypes = InstanceTypes.Where(type.IsAssignableFrom);
        ...
        public IEnumerable<EntityCollectionProviderAttribute> GetProviderAttributes()
        {
            ...
            return InstanceTypes.Select(x => x.GetCustomAttribute<EntityCollectionProviderAttribute>(false));
        }
        ...
        internal void RemoveFromCache(Guid collectionKey)
        {
            ...
            {
                MultiLogHelper.Info<EntityCollectionProviderResolver>("Failed to remove provider associated with collect " + collectionKey + " from cache");
            }
        }
        ...
        private void Initialize()
        {
            ...
            foreach (var reg in unregistered)
            {
                ...
                {
                    var collection = _merchelloContext.Services.EntityCollectionService.Create(
                        att.EntityTfKey,
                        att.Key,
                        att.Name);
