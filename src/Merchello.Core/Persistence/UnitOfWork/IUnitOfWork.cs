namespace Merchello.Core.Persistence.UnitOfWork
{
    ...
    public interface IUnitOfWork : IDisposable
	{
        ...
        /// This is useful e.g. when reading entities before creating, updating or deleting, and the read
        ...
        /// </summary>
        /// <remarks>
        /// <para>When a unit of work is flushed, all queued operations are executed. This is useful e.g.
