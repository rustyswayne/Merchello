namespace Merchello.Core.Persistence.Repositories
{
    ...
    internal class InvoiceLineItemRepository : NPocoLineItemRespositoryBase<IInvoiceLineItem, InvoiceItemDto, InvoiceLineItemFactory>, IInvoiceLineItemRepository
    {
        ...
        /// </param>
        public InvoiceLineItemRepository(IDatabaseUnitOfWork work, [Inject(Constants.Repository.DisabledCache)] ICacheHelper cache, ILogger logger, IMapperRegister mappers)
