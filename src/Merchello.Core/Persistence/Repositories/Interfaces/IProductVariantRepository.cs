namespace Merchello.Core.Persistence.Repositories
{
    ...
    /// <summary>
    /// Represents a repository responsible for <see cref="IProductVariant"/> entities.
    /// </summary>
    public interface IProductVariantRepository : INPocoEntityRepository<IProductVariant>, IBulkOperationRepository<IProductVariant>
    {
        /// <summary>
