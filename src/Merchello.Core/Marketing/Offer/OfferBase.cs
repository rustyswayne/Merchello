namespace Merchello.Core.Marketing.Offer
{
    ...
    public abstract class OfferBase : IOffer
    {
        ...
        /// </summary>
        private readonly IOfferComponentRegister _componentRegister;
        ...
        /// </summary>
        private IEnumerable<IOfferComponent> _components;

        /// <summary>
        /// Initializes a new instance of the <see cref="OfferBase"/> class.
        /// </summary>
        /// <param name="componentRegister">
        ...
        /// </param>
        protected OfferBase(IOfferComponentRegister componentRegister, IOfferProcessorFactory offerProcessorFactory, IOfferSettings settings)
        {
            Ensure.ParameterNotNull(componentRegister, nameof(componentRegister));
        ...
        /// </remarks>
        public Guid Key => this.Settings.Key;
        ...
        /// </summary>
        internal IOfferProcessor OfferProcessor => this._offerProcessor.Value;

        /// <summary>
        /// Gets the resolved components.
        /// </summary>
        private IEnumerable<IOfferComponent> ResolvedComponents => this._components ?? this._componentRegister.GetOfferComponents(this.Settings.ComponentDefinitions);
