namespace Merchello.Core.Logging
{
    ...
    public class MultiLogger : IMultiLogger
    {
        ...
        {
            _logger.Error(callingType, message, exception);
        ...
        {
            _logger.Warn(callingType, message, formatItems);
        ...
        {
            _logger.WarnWithException(callingType, message, e, formatItems);
        ...
        {
            _logger.Info(callingType, generateMessage);
        ...
        {
            _logger.Info(type, generateMessageFormat, formatItems);
        }
        ...
        {
            _logger.Debug(callingType, generateMessage);
        ...
        {
            _logger.Debug(type, generateMessageFormat, formatItems);
        }
        ...
        {
            _logger.Warn(callingType, message);
        ...
        {
            _logger.WarnWithException(callingType, message, exception);
        ...
        {
            _logger.Info(callingType, () => message);
        ...
        {
            _logger.Debug(callingType, () => message);
